...
#variable = lenom de la colonne qu'on veut regarder
...
mat_pvalue_cohorte_death <- p.adjust(mat_pvalue_death, method = "BH")
signif_death <- colnames(mat_pvalue_death)[which(mat_pvalue_death < 0.05)]
signif_cohorte_death <- colnames(mat_pvalue_cohorte_death)[which(mat_pvalue_cohorte_death < 0.05)]
