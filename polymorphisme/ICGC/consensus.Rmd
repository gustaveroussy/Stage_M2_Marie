...
#déséquilibre homozygotes vs hétérozygotes
```{r}
conting <- read.table("/Users/m_michel/Documents/stageM2/polymorphisme/ICGC/Fisher/snp_vs_cohorte/conting/21017240.txt")
conting <- conting[ , colSums(conting) != 0]
table <- rbind(colSums(conting[c(1,3),]), conting[2,])
